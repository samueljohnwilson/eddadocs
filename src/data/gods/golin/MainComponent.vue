<template>
  ...
  <v-card-text>
    ...
    sustains them. Among the Wydmyan, Golin is invoked before every hunt, and their hunters often
  ...
  <v-card-text>
    ...
    great bear that speaks the common tongue, or a giant hawk that soars above the clouds. They are
    said to be Golin's messengers, appearing to guide those he favors—or to warn those who have
    trespassed against him. Some whisper that certain mortal hunters, those who have proven their
    worth in life, are chosen to run with Golin's pack in death, their spirits forever bound to the
    endless wilderness.
  </v-card-text>
</template>
